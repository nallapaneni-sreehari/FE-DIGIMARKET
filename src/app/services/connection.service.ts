...
.pipe(
 ...
 getUsers():Observable<any>
  {
    return this.http.get<any>(environment.baseUrl1+"/api/User/all").pipe(catchError(this.handleError));
...
TriggerLogin(notification:any): Observable<any>{
  return this.http.post(environment.triggerAPI, JSON.stringify(notification));
}
